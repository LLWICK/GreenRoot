  ...
  return (
    <div className="rounded overflow-hidden shadow-lg flex flex-col">
      <div className="relative">
        <a href="#">
          <img className="w-full" src={image || "https://www.seedway.com/app/uploads/2021/09/Yaya-mat-1-1550x1029.jpg"} alt="Product Image" />
      ...
      <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
        <span className="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
          ...
          <span className="ml-1">Added 10 mins ago</span>
        </span>
        ...
        <span className="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
          ...
          <button
            ...
            onClick={() => deleteProduct(_id)} // Trigger delete function
          >
            Delete
          </button>
        </span>
