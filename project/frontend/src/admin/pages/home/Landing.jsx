      ...
      <section className="relative h-screen flex flex-col items-center justify-center text-center text-white">
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
          <video
            ...
            loop
          ></video>
          <div className="absolute inset-0  bg-opacity-60 transition-opacity duration-500"></div>
        </div>
        <div className="z-10 space-y-2">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <a
              href="#"
              className="px-6 py-2 border border-green-500 text-green-500 rounded-lg hover:bg-green-500 hover:text-white transition relative"
              onMouseEnter={(e) =>
                e.currentTarget
                  .closest("section")
                  .querySelector("div.absolute.inset-0")
                  .classList.add("bg-opacity-100")
              }
              onMouseLeave={(e) =>
                e.currentTarget
                  .closest("section")
                  .querySelector("div.absolute.inset-0")
                  .classList.remove("bg-opacity-80")
              }
            >
              Contact Us
            </a>
